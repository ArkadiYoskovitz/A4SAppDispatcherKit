...
Pod::Spec.new do |s|
    ...
    s.name             = 'AFSAppDispatcherKit'
    s.version          = '2.0.0'
    s.summary          = 'A short description of AFSAppDispatcherKit.'
    ...
    s.source_files        = 'AFSAppDispatcherKit/Code/**/*'
    s.public_header_files = 'AFSAppDispatcherKit/Code/**/*.h'
