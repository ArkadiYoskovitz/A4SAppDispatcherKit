...
open class AFSAppDelegateDispatcher : UIResponder {
    ...
    ///
    open func obtainServices() -> [AFSAppDelegateService] {
        
        return []
    }
    
    fileprivate lazy var _services : [AFSAppDelegateService] = {
...
extension AFSAppDelegateDispatcher : UIApplicationDelegate {
