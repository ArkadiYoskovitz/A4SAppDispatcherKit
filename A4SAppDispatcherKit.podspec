...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ArkadiGiniApps/A4SAppDispatcherKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ArkadiGiniApps' => 'a4s.development@gmail.com' }
  s.source           = { :git => 'https://github.com/ArkadiGiniApps/A4SAppDispatcherKit.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'A4SAppDispatcherKit' => ['A4SAppDispatcherKit/Assets/*.png']
  # }
